...
2. **Weight**: An Indication of how two neurons are connected. Denoted by $w_n$.
...
Where $a_k$ is the activation of any k$^{th}$ neuron.
...
<div style={{
    ...
    <span style={{
        ...
        ← Previous<br/>
        <span style={{color: '#999'}}>This is the first post</span>
    </span>
    <a
    ...
    >
        Next →<br/>
        <span style={{fontWeight: 500, textDecoration: "underline"}}>Backpropagation</span>
    </a>
</div>
