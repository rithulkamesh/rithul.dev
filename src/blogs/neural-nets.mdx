...
Alright, it's 2024, AI and ML has been the biggest thing for the last few years. But what does it do? How do computers actually learn?
...
Measuring how accurate a model is done using a <u>Cost Function</u>.
#### Cost Function
...
Alright, this is a lot of information for one blog, In the next part of this series, we'll cover **Backpropogation** along with the math it covers. This is used to calculate the negative gradient to nudge your weights and biases to increase network efficiency.
